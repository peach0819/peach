CREATE TABLE `t_touch_task_detail` (
  ...
  KEY `idx_task_id_detail_status_second_push` (`task_id`,`detail_status`,`second_push`)
) ENGINE=InnoDB AUTO_INCREMENT=1127297 DEFAULT CHARSET=utf8mb4 COMMENT='触达任务明细'