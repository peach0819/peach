    ...
    WHERE dayid = '${v_date}'
         ...
         FROM (
             ...
             WHERE dayid = '${v_date}'
               ...
               AND include_flag = 1
                  ...
                  JOIN all_item ON subject_main.item_style = subject_brand.item_style
     ...
     subject_not_exist_brand AS (
         ...
         FROM (
                  ...
                  JOIN all_item ON subject_item_style.item_style = all_item.item_style
     )
