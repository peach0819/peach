CREATE TABLE `t_crm_tuse_wx_group_msg` (
  ...
  `tuse_to_wx_id` varchar(1000) COMMENT '接收者涂色微信id',
  `tuse_group_id` varchar(100) NOT NULL COMMENT '涂色微信群id',
  `tuse_msg_type` int(10) DEFAULT NULL COMMENT '涂色微信消息类型',
  `tuse_msg_id` varchar(150) NOT NULL COMMENT '涂色微信消息id',
  `tuse_msg_content` text COMMENT '涂色微信消息内容',
  `tuse_meta_msg_content` text COMMENT '涂色微信消息原内容',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='涂色个微群聊消息';