...
--新增二级销售团队标识
INSERT INTO `bounty_filter` (`id`, `title`, `key`, `field_sql`, `required`, `global`, `global_type`, `plan_date_sign`, `component_type`, `component_value_config`)
VALUES (37, '二级销售团队标识', 'second_sales_team', 'second_sales_team', 1, 1, 1, 0, 'enum_multi_select', '{"type":"url", "url":"hipac.datacenter.filterContent.queryFilterContentList","code":"second_sale_team"}');
