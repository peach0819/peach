...
function supply_forward() {
    supply_date=$1
    data_date=$2
    sh ./dw_salary_gmv_rule_public_forward_d.sh $data_date 0 0 $supply_date
    sh ./dw_salary_forward_plan_sum_gmv_rule_d.sh $data_date 0 0 $supply_date
}

function supply_backward() {
    supply_date=$1
    data_date=$2
    sh ./dw_salary_gmv_rule_public_backward_d.sh $data_date 0 0 $supply_date
    sh ./dw_salary_backward_plan_sum_mid_gmv_rule_d.sh $data_date 0 0 $supply_date
}
