with plan as (
    ...
    WHERE array_contains(split(forward_date, ','), '$v_date')
     ...
     cur as (
         ...
         where pay_day between calculate_date_value_start and calculate_date_value_end
     ...
     old_data as (
         SELECT * FROM dw_salary_gmv_rule_public_d WHERE dayid='$v_date' AND pltype='cur'
     )
