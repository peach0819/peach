...
before_cur as (
    SELECT /*+ mapjoin(plan) */
           ...
           case when plan.bounty_payout_object_code = 'WAR_ZONE_MANAGE' then war_zone_id
                ...
                when plan.bounty_payout_object_code = 'BD' then COALESCE(yt_crm.get_service_info('service_job_name:BD;service_job_freezed_name:BD',service_info_freezed,'service_user_id'), yt_crm.get_service_info('service_job_name:省区M0',service_info_freezed,'service_user_id'))
                ...
                when plan.bounty_payout_object_code = 'BD_BIG_BD' then COALESCE(yt_crm.get_service_info('service_job_name:大BD',service_info_freezed,'service_user_id'), yt_crm.get_service_info('service_job_name:BD;service_job_freezed_name:BD',service_info_freezed,'service_user_id'), yt_crm.get_service_info('service_job_name:省区M0',service_info_freezed,'service_user_id'))
           ...
           case when plan.bounty_payout_object_code = 'WAR_ZONE_MANAGE' then war_zone_name
                ...
                when plan.bounty_payout_object_code = 'BD' then COALESCE(yt_crm.get_service_info('service_job_name:BD;service_job_freezed_name:BD',service_info_freezed,'service_user_name'), yt_crm.get_service_info('service_job_name:省区M0',service_info_freezed,'service_user_name'))
                ...
                when plan.bounty_payout_object_code = 'BD_BIG_BD' then COALESCE(yt_crm.get_service_info('service_job_name:大BD',service_info_freezed,'service_user_name'), yt_crm.get_service_info('service_job_name:BD;service_job_freezed_name:BD',service_info_freezed,'service_user_name'), yt_crm.get_service_info('service_job_name:省区M0',service_info_freezed,'service_user_name'))
           ...
           case when plan.bounty_payout_object_code = 'WAR_ZONE_MANAGE' then war_zone_dep_id
                ...
                when plan.bounty_payout_object_code = 'BD' then COALESCE(yt_crm.get_service_info('service_job_name:BD;service_job_freezed_name:BD',service_info_freezed,'service_department_id'), yt_crm.get_service_info('service_job_name:省区M0',service_info_freezed,'service_department_id'))
                ...
                when plan.bounty_payout_object_code = 'BD_BIG_BD' then COALESCE(yt_crm.get_service_info('service_job_name:大BD',service_info_freezed,'service_department_id'), yt_crm.get_service_info('service_job_name:BD;service_job_freezed_name:BD',service_info_freezed,'service_department_id'), yt_crm.get_service_info('service_job_name:省区M0',service_info_freezed,'service_department_id'))
           ...
           case when plan.bounty_payout_object_code = 'WAR_ZONE_MANAGE' then war_zone_dep_name
                ...
                when plan.bounty_payout_object_code = 'BD' then COALESCE(yt_crm.get_service_info('service_job_name:BD;service_job_freezed_name:BD',service_info_freezed,'service_department_name'), yt_crm.get_service_info('service_job_name:省区M0',service_info_freezed,'service_department_name'))
                ...
                when plan.bounty_payout_object_code = 'BD_BIG_BD' then COALESCE(yt_crm.get_service_info('service_job_name:大BD',service_info_freezed,'service_department_name'), yt_crm.get_service_info('service_job_name:BD;service_job_freezed_name:BD',service_info_freezed,'service_department_name'), yt_crm.get_service_info('service_job_name:省区M0',service_info_freezed,'service_department_name'))
                end as grant_object_user_dep_name,

           ---统计指标----
           case when plan.bounty_indicator_code in ('STOCK_GMV_1_GOODS_GMV_MINUS_REFUND', 'STOCK_GMV_AVG_GOODS_GMV_MINUS_REFUND', 'GMV_SHIHUO_RATE', 'GMV_SHIHUO_SHOP_COUNT', 'AVG_GMV_SHIHUO_SHOP_COUNT') then ord.gmv_less_refund --实货GMV(去退款)
                ...
                when plan.bounty_indicator_code in ('HI_RECHARGE_GMV_LESS_REFUND', 'AVG_HI_RECHARGE_GMV_LESS_REFUND', 'GMV_HI_SHOP_COUNT') then ord.hi_recharge_gmv_less_refund  --hi卡充值gmv(去退款)
                end as sts_target,
           ...
           to_json(named_struct(
               ...
               'brand_series_id', ord.brand_series_id,
               'brand_series_name', ord.brand_series_name,
               'brand_key', ord.brand_key,
