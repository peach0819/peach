...
(
  ...
  group by bd_manager_id
)bd_manager_shop_cnt on bd_manager.bd_manager_id=bd_manager_shop_cnt.bd_manager_id

union all

select
  '大区经理' as user_type_subdivide,
...
(
  ...
  group by area_manager_id
)area_manager_shop_cnt on area_manager.area_manager_id=area_manager_shop_cnt.area_manager_id
...
(
  ...
  group by war_zone_id
)war_zone_shop_cnt on war_zone.war_zone_id=war_zone_shop_cnt.war_zone_id
...
(
  ...
  group by staff_id
)staff_shop_cnt on staff.staff_id=staff_shop_cnt.staff_id
